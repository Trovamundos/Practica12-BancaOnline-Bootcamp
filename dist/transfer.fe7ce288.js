...
exports.insertTransfer = exports.getAccountList = void 0;
...
var getAccountList = function getAccountList() {
  return _axios.default.get(urlAccountList).then(function (response) {
...
var insertTransfer = function insertTransfer(transfer) {
  return _axios.default.post(urlTransfer, transfer).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
},{}],"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.laterDate = void 0;
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/transfer/transfer.validations.js":[function(require,module,exports) {
"use strict";
...
var dayValidator = function dayValidator(_ref, month, year) {
...
var yearValidator = function yearValidator(_ref3) {
  ...
  var succeeded = parseInt(value) > 2021 && parseInt(value) < 2021 + 10;
  return {
    succeeded: succeeded,
    message: succeeded ? '' : 'Por favor, introduzca un número correcto'
  };
...
var validationSchema = {
  field: {
    ...
    date: [{
      validator: _fonkLaterDateValidator.laterDate.validator,
      customArgs: {
        parseStringToDateFn: function parseStringToDateFn(value) {
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-later-date-validator":"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js"}],"pages/transfer/transfer.js":[function(require,module,exports) {
"use strict";
...
var _transfer = require("./transfer.api");
...
if (isEditMode) {
  (0, _transfer.getAccountList)().then(function (accountList) {
    (0, _transfer2.setAccountOptions)(accountList, params.id);
  ...
  (0, _transfer.getAccountList)().then(function (accountList) {
    (0, _transfer2.setAccountOptions)(accountList);
  });
}
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer3.formValidation.validateForm(transfer).then(function (result) {
    ...
    if (result.succeeded) {
      (0, _transfer.insertTransfer)(transfer).then(function () {
...
},{"../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js","./transfer.api":"pages/transfer/transfer.api.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","./transfer.validations":"pages/transfer/transfer.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];

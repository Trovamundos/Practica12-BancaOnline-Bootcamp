...
exports.getAccounts = exports.getMovements = void 0;
...
var urlAccounts = "".concat("http://localhost:3000/api", "/account-list");

var getMovements = function getMovements(id) {
  return _axios.default.get(urlMovements, {
    params: {
      accountId: id
    }
...
var getAccounts = function getAccounts(id) {
  return _axios.default.get("".concat(urlAccounts, "/").concat(id)).then(function (response) {
    return response.data;
  });
};
...
exports.mapMovementsFromApiToViewModel = exports.mapAccountFromApiToViewModel = void 0;
...
var mapMovementFromApiToViewModel = function mapMovementFromApiToViewModel(movement) {
...
var mapMovementsFromApiToViewModel = function mapMovementsFromApiToViewModel(movements) {
  return movements.map(function (movement) {
    return mapMovementFromApiToViewModel(movement);
  });
};
...
var isSpecificAccount = Boolean(params.id);

if (isSpecificAccount) {
  (0, _movements.getAccounts)(params.id).then(function (account) {
    return (0, _helpers.onSetValues)((0, _movements3.mapAccountFromApiToViewModel)(account));
  });
  (0, _movements.getMovements)(params.id).then(function (movements) {
    return (0, _movements2.addMovementRows)((0, _movements3.mapMovementsFromApiToViewModel)(movements));
  });
} else {
